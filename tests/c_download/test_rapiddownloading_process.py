...
@pytest.fixture
def rapidzipdownloader(tmp_path) -> RapidDownloadingProcess:
    ...
    yield RapidDownloadingProcess(rapidurlbuilder=rapidurlbuilder,
...
def test_get_latest_quarter_file_name(rapidzipdownloader):
    with patch('secfsdstools.c_download.rapiddownloading_process.get_filenames_in_directory',
