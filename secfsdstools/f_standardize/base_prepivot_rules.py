...
# Evtl. kann die PrivotRule grösstenteils mit dem Rule Interface verwendet werden.
# einzig die Process methode, in welcher auch das log gesetzt wird, müsste evtl. separat implementiert
# werden

# unter umständen könnte man soger deduplicate auch so lösen
