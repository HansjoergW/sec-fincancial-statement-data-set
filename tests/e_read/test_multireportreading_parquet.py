...
def test_read_raw_data(multireportreaderparquet):
    assert multireportreaderparquet.sub_df.shape == (2, 37)
    assert multireportreaderparquet.num_df.shape == (321, 10)
    assert multireportreaderparquet.pre_df.shape == (211, 11)


def test_statistics(multireportreaderparquet):
    stats = multireportreaderparquet.statistics()
